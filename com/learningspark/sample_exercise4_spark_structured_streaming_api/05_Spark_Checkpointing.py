...
def checkpoint_exercise():
    ...
    stream_query = rate_raw_data.writeStream.format("console").queryName("Default").option("checkpointLocation", "/tmp/checkpoint").start()
    #this checkpoint location requires HDFS-like filesystem
